...
var renderResume = function () {
    ...
    var renderedContent = "\n    <style>\n    \n      .resume-container {\n        width: 80%;\n        margin: 20px auto;\n        font-family: Arial, sans-serif;\n        border: 1px solid #ccc;\n        padding: 20px;\n        border-radius: 10px;\n        background-color: #f9f9f9;\n      }\n      .resume-title {\n        text-align: center;\n        font-size: 24px;\n        font-weight: bold;\n      }\n      .section-title {\n        font-size: 18px;\n        margin-top: 20px;\n        margin-bottom: 10px;\n      }\n\n      @media only screen and (max-width: 650px) {\n         /* For mobile phones: */\n        .resume-container {\n            width: 90%; /* Adjust the width to fit better on mobile screens */\n            padding: 15px; /* Adjust padding for smaller screens */\n           font-size: 14px; /* Decrease font size slightly for readability on small screens */\n        }\n\n      .personal-info {\n          display: block; /* Stack the elements vertically */\n          text-align: center; /* Center align for a cleaner layout */\n          margin: 0 auto; /* Center the personal info section */\n        }\n\n      .profile-picture {\n          width: 80px; /* Make the profile picture smaller */\n          height: 80px; /* Adjust the height to match the width */\n          margin: 0 auto 10px; /* Center and add some margin below the image */\n        }\n\n      .section-title {\n          font-size: 16px; /* Adjust font size for section titles */\n          margin-top: 15px;\n          margin-bottom: 8px;\n        }\n\n      .education-item, .skills-item, .work-experience-item , .additional-Information-item {\n          font-size: 14px; /* Adjust font size for list items */\n  }\n}\n\n      .personal-info, .education-list, .skills-list, .work-experience-list .{\n        margin-left: 20px;\n      }\n      .profile-picture {\n        width: 100px;\n        height: 100px;\n        border-radius: 50%;\n        margin-bottom: 10px;\n      }\n      .education-item, .skills-item, .work-experience-item, .additional-information-item{\n        margin-bottom: 10px;\n      }\n      .edit-btn, .delete-btn {\n        margin-left: 10px;\n        padding: 3px 8px;\n        font-size: 12px;\n        cursor: pointer;\n      }\n      .edit-btn {\n        background-color: #4CAF50;\n        color: white;\n        border: none;\n        border-radius: 5px;\n      }\n      .delete-btn {\n        background-color: #f44336;\n        color: white;\n        border: none;\n        border-radius: 5px;\n      }\n    </style>\n\n    <div class=\"resume-container\">\n      <h2 class=\"resume-title\">Resume</h2>\n      \n      <h3 class=\"section-title\">Personal Information</h3>\n      <div class=\"personal-info\">\n        ".concat(profilePictureURL
        ...
        .map(function (info, index) { return "\n    <li class=\"additional-Information-item\">\n      <strong>Languages:</strong> ".concat(info.languages, " \n      <button type=\"button\" class=\"delete-btn\" onclick=\"deleteAdditionalInfo(").concat(index, ", 'languages')\">Delete Languages</button>\n    </li>\n    <li class=\"additional-Information-item\">\n      <strong>Hobbies:</strong> ").concat(info.hobbies, " \n      <button type=\"button\" class=\"delete-btn\" onclick=\"deleteAdditionalInfo(").concat(index, ", 'hobbies')\">Delete Hobbies</button>\n    </li>\n    <li class=\"additional-Information-item\">\n      <strong>References:</strong> ").concat(info.references, " \n      <button type=\"button\" class=\"delete-btn\" onclick=\"deleteAdditionalInfo(").concat(index, ", 'references')\">Delete References</button>\n    </li>\n  "); })
        .join(""), "\n</ul>\n    </div>\n  ");
    ...
    var downloadContent = "\n    <style>\n      /* Same styles as above */\n      .resume-container {\n        width: 80%;\n        margin: 20px auto;\n        font-family: Arial, sans-serif;\n        border: 1px solid #ccc;\n        padding: 20px;\n        border-radius: 10px;\n        background-color: #f9f9f9;\n      }\n      .resume-title {\n        text-align: center;\n        font-size: 24px;\n        font-weight: bold;\n      }\n      .section-title {\n        font-size: 18px;\n        margin-top: 20px;\n        margin-bottom: 10px;\n      }\n      .personal-info, .education-list, .skills-list, .work-experience-list, .additional-information-list {\n        margin-left: 20px;\n      }\n      .profile-picture {\n        width: 100px;\n        height: 100px;\n        border-radius: 50%;\n        margin-bottom: 10px;\n      }\n      .education-item, .skills-item, .work-experience-item .additional-information-item{\n        margin-bottom: 10px;\n      }\n        \n.resume-output {\n  background-color: #f9f9f9;\n  padding: 20px;\n  border: 1px solid #ddd;\n  border-radius: 8px;\n  min-height: 200px;\n  font-size: 16px;\n  color: #555;\n}\n\n@media print {\n  .container .header{\n    display: none;\n    }\n  form {\n    display: none;\n  }\n\n  .resume-output {\n    font-size: 14px;\n    color: #000;\n  }\n\n  body {\n    background-color: white;\n  }\n\n  button {\n    display: none;\n  }\n  #username{\n    display: none;\n  }\n}\n\n#profilePicturePreview {\n  max-width: 150px;\n  display: none;\n}\n\n.resume-output img {\n  max-width: 150px;\n  border-radius: 50%;\n  margin-bottom: 15px;\n}\n\n/*  */\n/* Resume container */\n.resume-container {\n  font-family: Arial, sans-serif;\n  line-height: 1.6;\n  color: #333;\n  max-width: 800px;\n  margin: 0 auto;\n  padding: 20px;\n  background: #f9f9f9;\n  border-radius: 10px;\n}\n\n/* Title styling */\n.resume-title {\n  text-align: center;\n  color: #007bff;\n}\n\n/* Section title styling */\n.section-title {\n  border-bottom: 2px solid #007bff;\n  padding-bottom: 5px;\n  margin-bottom: 15px;\n  color: #333;\n}\n\n/* Personal info styling */\n.personal-info {\n  display: flex;\n  align-items: center;\n  gap: 15px;\n}\n\n.profile-picture {\n  border-radius: 50%;\n  width: 150px;\n  height: 150px;\n  object-fit: cover;\n}\n\n/* List styling */\n.education-list,\n.skills-list,\n.work-experience-list {\n  list-style-type: none;\n  padding: 0;\n}\n\n.education-item,\n.skills-item,\n.work-experience-item \n.additional-information-item{\n  padding: 10px;\n  border-bottom: 1px solid #ddd;\n}\n\n/* Button styling */\n.edit-btn,\n.delete-btn {\n  background-color: #007bff;\n  border: none;\n  color: white;\n  padding: 5px 10px;\n  margin-left: 10px;\n  border-radius: 5px;\n  cursor: pointer;\n  font-size: 14px;\n  transition: background-color 0.3s;\n}\n\n.work-description {\n  display: block;\n  margin-top: 5px;\n  font-style: italic;\n}\n    </style>\n\n    <div class=\"resume-container\">\n      <h2 class=\"resume-title\">Resume</h2>\n      \n      <h3 class=\"section-title\">Personal Information</h3>\n      <div class=\"personal-info\">\n        ".concat(profilePictureURL
        ...
        .join(""), "\n      </ul>\n      <h3 class=\"section-title\">Additional Information</h3>\n      <ul class=\"additional-information-list\">\n        ").concat(additionalInformation
        .map(function (info) { return "\n              <li class=\"additional-information-item\">\n                <strong>Languages:</strong> ".concat(info.languages || "N/A", "<br>\n                <strong>Hobbies:</strong> ").concat(info.hobbies || "N/A", "<br>\n                <strong>References:</strong> ").concat(info.references || "N/A", "<br>\n              </li>\n            "); })
        .join(""), "\n      </ul>\n    </div>\n\n\n  ");
...
(_e = document.getElementById("addInfo")) === null || _e === void 0 ? void 0 : _e.addEventListener("click", function (e) {
    e.preventDefault();
    var languages = document.getElementById("languages").value;
    var hobbies = document.getElementById("hobbies").value;
    var references = document.getElementById("references").value;
    if (languages || hobbies || references) {
        additionalInformation.push({ languages: languages, hobbies: hobbies, references: references });
        renderResume();
    }
});
// Form Submit Handler
...
window.deleteAdditionalInfo = function (index, field) {
    var info = additionalInformation[index];
    if (field === 'languages') {
        info.languages = '';
    }
